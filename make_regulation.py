...
class PDF(FPDF):
    def header(self):
        self.set_font('NanumSquare', '', 14)
        self.cell(0, 10, '군 부서별 담당업무 예규', 0, 1, 'C')
        self.ln(5)

    def chapter_title(self, chapter_title):
        self.set_font('NanumSquare', '', 12)
        self.set_fill_color(200, 220, 255)
        self.cell(0, 10, chapter_title, 0, 1, 'L', 1)
        self.ln(2)

    def chapter_body(self, body):
        self.set_font('NanumSquare', '', 11)
        self.multi_cell(0, 6, body)
        self.ln()

# PDF 객체 생성 및 한글 폰트 등록
pdf = PDF()
pdf.add_font('NanumSquare', '', r'C:\NanumSquareNeo-aLt.ttf', uni=True)
...
# PDF 작성
for dept, content in departments.items():
    pdf.add_page()
